<a href="" wire:poll.15s="checkNotifications" class="relative text-white/80 lg:text-gray-400 hover:text-white lg:hover:text-[#102b70] transition-colors p-1" aria-label="View overdue items">
    <!-- Bell Icon -->
