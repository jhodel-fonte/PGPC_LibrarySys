    ...
    <div class="mx-auto w-full max-w-[1420px] p-4 lg:p-6 space-y-6 relative">
        ...
        <div class="relative z-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            ...
            <div class="flex items-center gap-3" x-data="{ saved: false }" x-on:settings-saved.window="saved = true; setTimeout(() => saved = false, 3000)">
                ...
                @endif
                <button wire:click="saveChanges" wire:loading.attr="disabled" class="flex items-center justify-center gap-2 h-10 px-4 min-w-[140px] rounded-lg bg-[#17357A] hover:bg-[#122D68] text-white text-sm font-semibold transition-all shadow-sm {{ $isDirty ? 'ring-2 ring-offset-2 ring-[#17357A]/50' : '' }} disabled:opacity-75 disabled:cursor-not-allowed">
        ...
        <div class="relative z-10 flex flex-col lg:grid lg:grid-cols-[250px_minmax(0,1120px)] lg:justify-center gap-5 lg:gap-6 items-start">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-2 shadow-sm sticky top-6">
                ...
                <button wire:click="setTab('general')" class="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors text-left {{ $activeTab === 'general' ? 'bg-[#EEF3FF] text-[#17357A] font-semibold' : 'text-slate-600 hover:bg-slate-50 hover:text-[#17357A]' }}">
                ...
                <button wire:click="setTab('circulation')" class="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors text-left {{ $activeTab === 'circulation' ? 'bg-[#EEF3FF] text-[#17357A] font-semibold' : 'text-slate-600 hover:bg-slate-50 hover:text-[#17357A]' }}">
                ...
                <button wire:click="setTab('content')" class="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors text-left {{ $activeTab === 'content' ? 'bg-[#EEF3FF] text-[#17357A] font-semibold' : 'text-slate-600 hover:bg-slate-50 hover:text-[#17357A]' }}">
                ...
                <button wire:click="setTab('notifications')" class="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors text-left {{ $activeTab === 'notifications' ? 'bg-[#EEF3FF] text-[#17357A] font-semibold' : 'text-slate-600 hover:bg-slate-50 hover:text-[#17357A]' }}">
                ...
                <button wire:click="setTab('ai')" class="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors text-left {{ $activeTab === 'ai' ? 'bg-[#EEF3FF] text-[#17357A] font-semibold' : 'text-slate-600 hover:bg-slate-50 hover:text-[#17357A]' }}">
